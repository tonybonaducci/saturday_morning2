...
def fcv_5(full_set, n_examples, part_lengths,atributes,i,set_type,seed):
      ...
      start = time.time()
      poblacion, mejor_fit, c_mejor, r_mejor, indice_mejor, cromosoma = genetico.AGG_BLX(train_data,train_labels,weights,atributes)
      end = time.time()   
      ...
      start = time.time()
      poblacion, mejor_fit, c_mejor, r_mejor, indice_mejor,cromosoma = genetico.AGG_aritmetico(train_data,train_labels,weights,atributes)
      end = time.time()   
